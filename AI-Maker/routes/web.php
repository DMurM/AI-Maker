...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/remove-background', [BackgroundRemovalController::class, 'showForm'])->name('removeBackground.form'); 
    Route::post('/remove-background', [BackgroundRemovalController::class, 'removeBackground'])->name('removeBackground'); 
});
...
Route::get('/ai-tools/background-remover', [BackgroundRemovalController::class, 'showForm'])->name('ai-tools.background-remover');
