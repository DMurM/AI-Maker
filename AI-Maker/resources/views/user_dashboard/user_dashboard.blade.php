...
<head>
	...
	<style>
        .line-div {
            ...
            height: 0; /* Asegura que solo se vea el borde */
        }
		.icon {
    ...
    <link rel="stylesheet" href="../../../public/css/user_dashboard.blade.css">
</head>
<body>
                ...
                <div class="d-flex flex-column h-100">
                    <div class="flex-grow-1">
                        ...
                        <ul class="nav flex-column mt-3">
                            <li class="nav-item">
                                <a class="nav-link text-white d-flex align-items-center" href="#">
									<img src="/images/dashpics/imageneration.svg" class="icon" alt="Image Generation">Image Generation</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white d-flex align-items-center" href="#">
									<img src="/images/dashpics/imagedit.svg" class="icon" alt="Image Editing">Image Editing</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white d-flex align-items-center" href="#">
									<img src="/images/dashpics/videotools.svg" class="icon" alt="Video Tools">Video Tools</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white d-flex align-items-center" href="#">
									<img src="/images/dashpics/audiotool.svg" class="icon" alt="Audio Tools">Audio Tools</a>
                            </li>
                        </ul>
                    </div>
